...
[
<<EOS,
undefinedenvval   @env(UNDEFINEDENVVAL,"defaultEnvValue")
EOS
  { 
    undefinedenvval: "defaultEnvValue",
  }
],
...
[
<<EOS,
myspecialenv100   @env(MYSPECIALENV100)
undefinedenvval   @env(UNDEFINEDENVVAL,"defaultEnvValue")
EOS
  { 
    myspecialenv100: "mySpecialEnvValue_100",
    undefinedenvval: "defaultEnvValue",
  }
],
